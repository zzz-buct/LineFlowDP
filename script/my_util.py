...
class InMemoryDataset(Dataset):
    ...
    def num_classes(self) -> int:
        r"""Returns the number of classes in the datasets."""
        y = self.data.y
        if y is None:
            return 0
    ...
    def copy(self, idx: Optional[IndexType] = None) -> 'InMemoryDataset':
        r"""Performs a deep-copy of the datasets. If :obj:`idx` is not given,
    ...
    def __init__(self, root: str, name: str,
        ...
        if not isinstance(out, tuple) and len(out) != 3:
            raise RuntimeError(
                ...
                "datasets, remove the 'processed/' directory in the datasets's "
